...
use Inventory\Suppliers\{ SuppliersDto, SuppliersModel, ISuppliersService, SuppliersService };
...
class SuppliersServiceTest extends TestCase
{
    ...
    {
        $this->repository = $this->createMock("Inventory\Suppliers\ISuppliersRepository");
        $this->input = [
            "id" => 8882,
            "supplier" => "memory",
        ];
