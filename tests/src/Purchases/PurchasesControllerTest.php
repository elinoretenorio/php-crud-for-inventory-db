...
use Inventory\Purchases\{ PurchasesDto, PurchasesModel, PurchasesController };
...
class PurchasesControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        $this->input = [
            ...
            "supplier_id" => 2486,
            "product_id" => 6783,
            "number_received" => 4767,
            "purchase_date" => "2021-09-27",
        ];
        $this->dto = new PurchasesDto($this->input);
        $this->model = new PurchasesModel($this->dto);
        $this->service = $this->createMock("Inventory\Purchases\IPurchasesService");
        $this->request = $this->createMock("Psr\Http\Message\ServerRequestInterface");
        $this->stream = $this->createMock("Psr\Http\Message\StreamInterface");
        $this->controller = new PurchasesController(
            $this->service
        );
